...
public final class ModItems {
	...
	//Tool Materials
	public static ToolMaterial tutMaterial = EnumHelper.addToolMaterial("BloodSteelorial Tool Material", 3, 200, 15.0F, 4.0F, 10);
	
	//Armour Materials
	public static ArmorMaterial tutArmorMaterial = EnumHelper.addArmorMaterial("BloodSteelorial Armor Material", 33, new int[]{2, 5, 4, 2}, 10);
