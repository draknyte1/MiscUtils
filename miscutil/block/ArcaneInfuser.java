...
public class ArcaneInfuser extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconregister) {
		this.blockIcon = iconregister.registerIcon(Strings.MODID + ":ArcaneInfuserSide");
		this.front = iconregister.registerIcon(this.isBurning2 ? Strings.MODID + ":ArcaneInfuserActive" : Strings.MODID + ":ArcaneInfuserInactive");
		this.top = iconregister.registerIcon(Strings.MODID + ":ArcaneInfuserTop");
	}
