...
public class BloodSteelWorldGenOre implements IWorldGenerator {
	...
	private void generateSurface(Random random, int chunkX, int chunkZ, World world) {
		//addOre(ModBlocks.tutBlock, Blocks.stone, random, world, chunkX, chunkZ, 20, 60, 10, 20, 20);
	}
