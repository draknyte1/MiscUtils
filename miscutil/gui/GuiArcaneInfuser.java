...
public class GuiArcaneInfuser extends GuiContainer{
	...
	private TileEntityArcaneInfuser tileFurnace;

	public GuiArcaneInfuser(InventoryPlayer invPlayer, TileEntityArcaneInfuser tile) {
		super(new ContainerArcaneInfuser(invPlayer, tile));
