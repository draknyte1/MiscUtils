  ...
  public void initialiseClient()
  {
    ...
    createMode(Mode.Branches, new ModeWidgets(Mode.Branches, this)
    {
      public void createListBox(IArea area)
      {
        ...
        GameProfile playerName = WindowAbstractDatabase.this.getUsername();
        Collection<IClassification> speciesList = this.database.isNEI ? this.database.system.getAllBranches() : this.database.system.getDiscoveredBranches(this.database.getWorld(), playerName);
