  ...
  extends Window
{
  ...
  public void initialiseClient()
  {
    ...
    {
      public ControlTab createTab(float x, float y, float w, float h, BreedingSystem value)
      {
    ...
    refreshTemplate((IChromosomeType)null);
  }
  ...
  private void refreshTemplate(IChromosomeType selection)
  {
    ...
    Object map = Binnie.Genetics.getChromosomeMap(this.root);
