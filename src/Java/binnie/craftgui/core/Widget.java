  ...
  implements IWidget
{
  ...
  {
    return (ITopLevelWidget)(isTopLevel() ? this : this.parent.getSuperParent());
  }
  ...
  public final void recieveEvent(Event event)
  {
    ...
    try
    {
      for (??? = getWidgets().iterator(); ???.hasNext();)
      {
        IWidget child = (IWidget)???.next();
  ...
  public boolean isEnabled()
  {
    ...
    {
      if ((!isTopLevel()) && (
        (!getParent().isEnabled()) || (!getParent().isChildEnabled(this)))) {
        return false;
      }
      return true;
    }
  ...
  public final boolean isVisible()
  {
    ...
    {
      if ((!isTopLevel()) && (
        (!getParent().isVisible()) || (!getParent().isChildVisible(this)))) {
        return false;
      }
      return true;
    }
