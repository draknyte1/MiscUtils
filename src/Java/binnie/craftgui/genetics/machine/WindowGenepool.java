  ...
  extends WindowMachine
{
  ...
  public void initialiseClient()
  {
    ...
    x += 26;
    new ControlSlotArray(this, x, 35, 2, 3).create(Genepool.slotReserve);
    x += 38;
    new ControlIconDisplay(this, x, 54.0F, GUIIcon.ArrowRight.getIcon());
    x += 18;
    new ControlSlot(this, x, 53.0F).assign(0);
    x += 18;
    new ControlMachineProgress(this, x, 51, ProgressBase, Progress, Position.Left);
    x += 130;
