  ...
  extends WindowMachine
{
  ...
  public void initialiseClient()
  {
    ...
    int x = 16;
    int y = 38;
    new ControlSlotArray(this, x, 38, 1, 4).create(Polymeriser.slotSerumReserve);
    new ControlIconDisplay(this, x + 18, 39.0F, GUIIcon.ArrowRight.getIcon());
    x += 34;
    new ControlMachineProgress(this, x + 18, 32, ProgressBase, Progress, Position.Left);
    new ControlSlot(this, x, 38.0F).assign(0);
    new ControlLiquidTank(this, x, 72, true).setTankID(0);
    new ControlLiquidTank(this, x, 98, true).setTankID(1);
    new ControlEnergyBar(this, x + 120, 96, 64, 16, Position.Left);
    x += 40;
    new ControlSlot(this, x + 30, 64.0F).assign(1);
    new ControlSlotCharge(this, x + 30 + 20, 64, 1).setColour(16766976);
    x += 138;
    new ControlSlotArray(this, x, 47, 2, 2).create(Polymeriser.slotSerumFinished);
