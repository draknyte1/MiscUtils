  ...
  extends WindowMachine
{
  ...
  public void initialiseClient()
  {
    ...
    new Panel(this, boxX + 24, 32.0F, 120.0F, 120.0F, MinecraftGUI.PanelType.Black);
    new Panel(this, boxX + 24 + 120, 32.0F, 14.0F, 120.0F, MinecraftGUI.PanelType.Gray);
    ControlScrollableContent scroll = new ControlScrollableContent(this, boxX + 24 + 2, 34.0F, 130.0F, 116.0F, 12.0F);
    ControlTextEdit edit = new ControlTextEdit(this, boxX + 27 + 120 - 70, 18.0F, 80.0F, 12.0F);
    ...
    scroll.setScrollableContent(this.genes = new ControlGeneScroll(scroll, 1.0F, 1.0F, 120.0F, 116.0F));
      ...
      public ControlTab<BreedingSystem> createTab(float x, float y, float w, float h, BreedingSystem value)
      {
        new ControlTabIcon(this, x, y, w, h, value)
        {
          public void getTooltip(Tooltip tooltip)
          {
            ...
            for (Iterator localIterator1 = genes.entrySet().iterator(); localIterator1.hasNext();)
            {
    ...
    Panel panelProject = new Panel(this, boxX + 24, 160.0F, 140.0F, 50.0F, MinecraftGUI.PanelType.Black);
    int totalGenes = 0;
    int seqGenes = 0;
    for (Iterator localIterator1 = Binnie.Genetics.getActiveSystems().iterator(); localIterator1.hasNext();)
    {
      system = (BreedingSystem)localIterator1.next();
      ...
      for (localIterator2 = genes.entrySet().iterator(); localIterator2.hasNext();)
      {
