  ...
  extends WindowMachine
{
  ...
  public void initialiseClient()
  {
    ...
    int x = 16;
    int y = 32;
    new ControlSlotArray(this, x, 32, 2, 2).create(Acclimatiser.slotReserve);
    x += 54;
    new ControlSlot(this, x + 18, 32.0F).assign(4);
    new ControlSlotArray(this, x, 68, 3, 1).create(Acclimatiser.slotAcclimatiser);
    x += 72;
    new ControlSlotArray(this, x, 32, 2, 2).create(Acclimatiser.slotDone);
