  ...
  extends WindowMachine
{
  ...
  public void initialiseClient()
  {
    ...
    int x = 16;
    int y = 32;
    new ControlLiquidTank(this, x, 66).setTankID(0);
    CraftGUIUtil.horizontalGrid(x, 32.0F, new IWidget[] { new ControlSlotArray(this, 0, 0, 2, 1).create(Inoculator.slotSerumReserve), new ControlIconDisplay(this, 0.0F, 0.0F, GUIIcon.ArrowRight.getIcon()), new ControlSlot(this, 0.0F, 0.0F).assign(0), new ControlIconDisplay(this, 0.0F, 0.0F, GUIIcon.ArrowRight.getIcon()), new ControlSlotArray(this, 0, 0, 2, 1).create(Inoculator.slotSerumExpended) });
    x += 18;
    new ControlMachineProgress(this, x, 56, ProgressBase, Progress, Position.Left);
    new ControlEnergyBar(this, 91, 118, 60, 16, Position.Left);
    new ControlErrorState(this, 161.0F, 118.0F);
    x += 142;
    CraftGUIUtil.verticalGrid(x, 32.0F, TextJustification.MiddleLeft, 8.0F, new IWidget[] { new ControlSlotArray(this, x, 32, 4, 1).create(Inoculator.slotReserve), new ControlSlot(this, x, 58.0F).assign(9), new ControlSlotArray(this, x, 84, 4, 1).create(Inoculator.slotFinished) });
    new ControlIconDisplay(this, x + 18, 52.0F, GUIIcon.ArrowUpLeft.getIcon());
    new ControlIconDisplay(this, x + 18, 68.0F, GUIIcon.ArrowLeftDown.getIcon());
