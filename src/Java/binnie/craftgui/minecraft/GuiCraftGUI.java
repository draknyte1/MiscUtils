  ...
  extends GuiContainer
{
  ...
  public void renderTooltip(IPoint mousePosition, MinecraftTooltip tooltip)
  {
    ...
    drawGradientRect(i1 - 3, j1 + k2 + 3, i1 + k + 3, j1 + k2 + 4, -267386864, -267386864);
    drawGradientRect(i1 - 3, j1 - 3, i1 + k + 3, j1 + k2 + 3, -267386864, -267386864);
    drawGradientRect(i1 - 4, j1 - 3, i1 - 3, j1 + k2 + 3, -267386864, -267386864);
    drawGradientRect(i1 + k + 3, j1 - 3, i1 + k + 4, j1 + k2 + 3, -267386864, -267386864);
  ...
  protected void mouseMovedOrUp(int x, int y, int button)
  {
    ...
    if (button == -1)
    {
      ...
      float f1 = -(Mouse.getEventDY() * this.height / this.mc.displayHeight);
    }
    else
    {
