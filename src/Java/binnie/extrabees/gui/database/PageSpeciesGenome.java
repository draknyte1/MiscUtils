  ...
  extends PageSpecies
{
  ...
  public PageSpeciesGenome(IWidget parent, DatabaseTab tab)
  {
    ...
    int x = 72;
    this.pageSpeciesGenome_SpeedText = new ControlText(this, new IArea(72.0F, 32.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
    this.pageSpeciesGenome_LifespanText = new ControlText(this, new IArea(72.0F, 44.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
    this.pageSpeciesGenome_FertilityText = new ControlText(this, new IArea(72.0F, 56.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
    this.pageSpeciesGenome_FloweringText = new ControlText(this, new IArea(72.0F, 68.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
    this.pageSpeciesGenome_TerritoryText = new ControlText(this, new IArea(72.0F, 80.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
    this.pageSpeciesGenome_NocturnalText = new ControlText(this, new IArea(72.0F, 97.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
    this.pageSpeciesGenome_CaveDwellingText = new ControlText(this, new IArea(72.0F, 109.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
    this.pageSpeciesGenome_TolerantFlyerText = new ControlText(this, new IArea(72.0F, 121.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
    this.pageSpeciesGenome_FlowerText = new ControlText(this, new IArea(72.0F, 138.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
    this.pageSpeciesGenome_EffectText = new ControlText(this, new IArea(72.0F, 155.0F, 72.0F, 30.0F), "", TextJustification.TopLeft);
  }
