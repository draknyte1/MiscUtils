  ...
  implements IAlleleBeeSpecies, IIconProvider
{
  ...
  public static void doInit()
  {
    ...
    ExtraBeesSpecies species3;
    EnumHoneyComb comb;
    for (int i = 0; i < 16; i++)
    {
      species3 = values()[(RED.ordinal() + i)];
      comb = EnumHoneyComb.values()[(EnumHoneyComb.RED.ordinal() + i)];
    ...
    i = values();EnumHoneyComb localEnumHoneyComb1 = i.length;
    for (EnumHoneyComb localEnumHoneyComb2 = 0; localEnumHoneyComb2 < localEnumHoneyComb1; localEnumHoneyComb2++)
    {
      ExtraBeesSpecies species2 = i[localEnumHoneyComb2];
  ...
  public ItemStack[] getResearchBounty(World world, GameProfile researcher, IIndividual individual, int bountyLevel)
  {
    ...
    {
      combinations = getRoot().getCombinations(this);
