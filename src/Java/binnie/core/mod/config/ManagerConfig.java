        ...
        if (field.isAnnotationPresent(ConfigProperty.class))
        {
          ...
          for (Annotation annotation : field.getAnnotations()) {
            if (annotation.annotationType().isAnnotationPresent(ConfigProperty.Type.class))
            {
              ...
              PropertyBase localPropertyBase = (PropertyBase)propertyClass.getConstructor(new Class[] { Field.class, BinnieConfiguration.class, ConfigProperty.class, annotation.annotationType() }).newInstance(new Object[] { field, config, propertyAnnot, annotation.annotationType().cast(annotation) });
            }
          }
        }
      }
