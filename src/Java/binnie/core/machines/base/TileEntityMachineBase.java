  ...
  implements IInventoryMachine, ITankMachine, IPoweredMachine
{
  ...
  {
    return (!isInvalid()) && (getWorldObj().getTileEntity(this.xCoord, this.yCoord, this.zCoord) == this) && (entityplayer.getDistanceSq(this.xCoord + 0.5D, this.yCoord + 0.5D, this.zCoord + 0.5D) <= 64.0D) && (getInventory().isUseableByPlayer(entityplayer));
  }
