  ...
  public ItemStack transfer(boolean doAdd)
  {
    ...
    if (item != null) {
      for (int slot : this.targetSlots) {
        if (((this.destination.isItemValidForSlot(slot, item)) || (this.ignoreReadOnly)) && 
          ((!(this.destination instanceof IInventorySlots)) || (((IInventorySlots)this.destination).getSlot(slot) == null) || (!((IInventorySlots)this.destination).getSlot(slot).isRecipe())) && 
          (this.destination.getStackInSlot(slot) != null) && 
          (item.isStackable()))
        {
    ...
    if (item != null) {
      for (int slot : this.targetSlots) {
        if (((this.destination.isItemValidForSlot(slot, item)) || (this.ignoreReadOnly)) && 
          ((!(this.destination instanceof IInventorySlots)) || (((IInventorySlots)this.destination).getSlot(slot) == null) || (!((IInventorySlots)this.destination).getSlot(slot).isRecipe())) && 
          (this.destination.getStackInSlot(slot) == null) && (item != null))
        {
          this.insertedSlots.add(new TransferSlot(slot, this.destination));
          if (doAdd) {
