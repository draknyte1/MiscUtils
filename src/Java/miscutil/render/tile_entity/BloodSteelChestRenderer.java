package miscutil.render.tile_entity;
...
public class BloodSteelChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147505_d = new ResourceLocation(Strings.MODID + ":textures/blocks/LargeBloodSteelChest");
    private static final ResourceLocation field_147504_g = new ResourceLocation(Strings.MODID + ":textures/blocks/BloodSteelChest");
    private ModelChest field_147510_h = new ModelChest();
    private ModelChest field_147511_i = new ModelLargeChest();
    public BloodSteelChestRenderer()
    {
    ...
    public void renderTileEntityAt(TileEntityBloodSteelChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BloodSteelChest && i == 0)
            {
                try
                {
                ((BloodSteelChest)block).func_149954_e(p_147502_1_.getWorldObj(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
    ...
    {
        this.renderTileEntityAt((TileEntityBloodSteelChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}